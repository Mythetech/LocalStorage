...
namespace Mythetech.LocalStorage.Tests.LocalStorageServiceTests
{
    public class SetItemAsStringAsync
    {
        ...
        public async Task ThrowsArgumentNullException_When_KeyIsInvalid(string key)
        {
            ...
            // assert
            await Assert.ThrowsAsync<ArgumentNullException>(() => _sut.SetItemAsStringAsync(key, data).AsTask());
        }
        ...
        public async Task ThrowsArgumentNullException_When_DataIsNull()
        {
            ...
            // assert
            await Assert.ThrowsAsync<ArgumentNullException>(() => _sut.SetItemAsStringAsync("MyValue", data).AsTask());
        }
