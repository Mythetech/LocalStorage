...
using Mythetech.LocalStorage.Exceptions;
...
internal abstract class BrowserStorageProviderBase
{
    ...
    public IEnumerable<string> Keys()
    {
        ...
        try
        {
            return JSInProcessRuntime.Invoke<IEnumerable<string>>("getLocalStorageKeys");
        }
        catch (Exception exception)
        {
            if (IsStorageDisabledException(exception))
    ...
    public async ValueTask<IEnumerable<string>> KeysAsync(CancellationToken cancellationToken = default)
    {
        try
        {
            return await JSRuntime.InvokeAsync<IEnumerable<string>>("getLocalStorageKeys", cancellationToken);
        }
        catch (Exception exception)
        {
            if (IsStorageDisabledException(exception))
    ...
    public int Length()
    {
        ...
        try
        {
            return JSInProcessRuntime.Invoke<int>("getLocalStorageLength");
        }
        catch (Exception exception)
        {
            if (IsStorageDisabledException(exception))
    ...
    public async ValueTask<int> LengthAsync(CancellationToken cancellationToken = default)
    {
        try
        {
            return await JSRuntime.InvokeAsync<int>("getLocalStorageLength", cancellationToken);
        }
        catch (Exception exception)
        {
            if (IsStorageDisabledException(exception))
    ...
    public void RemoveItems(IEnumerable<string> keys)
    {
        ...
        try
        {
            JSInProcessRuntime.InvokeVoid("removeLocalStorageItems", keys);
        }
        catch (Exception exception)
        {
            if (IsStorageDisabledException(exception))
    ...
    public async ValueTask RemoveItemsAsync(IEnumerable<string> keys, CancellationToken cancellationToken = default)
    {
        try
        {
            await JSRuntime.InvokeVoidAsync("removeLocalStorageItems", cancellationToken, keys);
        }
        catch (Exception exception)
        {
            if (IsStorageDisabledException(exception))
